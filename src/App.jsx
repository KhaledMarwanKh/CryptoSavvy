      ...
      <div className='min-h-screen relative'>
        ...
        <main>
          <Routes>
            ...
            <Route path='/coin/analyze-chart/:coinId' element={localStorage.isAuth ? <ChartAnalyze /> : <Navigate to={"/auth/login"} />} />
            ...
            <Route path='/auth/profile' element={localStorage.isAuth ? <Profile /> : <Navigate to={"/auth/login"} />} />
            <Route path='/about' element={<About />} />
            <Route path='/contact' element={<Contact />} />
            <Route path='/ai/chat' element={localStorage.isAuth ? <AiChat /> : <Navigate to={"/auth/login"} />} />
            <Route path='/ai/analyze' element={localStorage.isAuth ? <AiAnalyze /> : <Navigate to={"/auth/login"} />} />
            <Route path='/currency-market' element={<CurrencyConverterAndRates />} />
            <Route path='/notification' element={<Notification />} />
            <Route path='*' element={localStorage.isAuth ? <RootNotFound /> : <Navigate to={"/auth/login"} />} />
          </Routes>
        </main>
