  ...
  useEffect(() => {
    ...
    newsHandler
      ...
      .then((res) => {
        ...
        setTotalNumber(res.count ?? res?.totalArticles);
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex items-center justify-between border-t border-slate-800/50 pt-4">
              <div className="text-sm text-slate-400">
                {t("news.showing")}{" "}
                <span className="text-slate-200">{totalNumber ?? 0}</span>{" "}
                {t("news.results")}
              </div>
              <div
              ...
              >
                ...
                <div className="mx-1 text-slate-300">{currentPage}</div>
                <button
