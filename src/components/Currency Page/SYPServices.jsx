        ...
        <div className="grid md:grid-cols-3 gap-4">
          ...
          <div>
            <label className="text-slate-300 text-sm">
              {t("sypServices.converter.amountLabel")}
            </label>
            <input
              type="number"
              value={amount}
          ...
          <div>
            <label className="text-slate-300 text-sm">
              {t("sypServices.converter.currencyLabel")}
            </label>
            <select
              value={currency}
          ...
          <div>
            <label className="text-slate-300 text-sm">
              {t("sypServices.converter.resultLabel")}
            </label>
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <div className="text-lg font-semibold">
                {t("sypServices.table.title")}
              </div>
            </div>
          </div>
          <div className="text-sm text-slate-400">
            {loadingTable
              ? t("sypServices.table.loading")
              : `${currencyData?.length} ${t("sypServices.table.currenciesCount")}`}
          </div>
        </div>
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="text-right">
                  <div className="text-lg font-semibold">
                    {
                      <div
                        className={`text-sm flex items-center gap-2 ${r.change[0] === "▲" ? "text-emerald-400" : "text-red-400"} `}
                      >
                        {r.change[0] === "▲" ? (
              ...
              <div className="mt-2 text-xs text-slate-400">
                <p>
                  <span className="text-sm text-slate-200">
                    {t("sypServices.table.mobile.buy")} :{" "}
                  </span>{" "}
                  {r.buy} SYP
                </p>
                <p>
                  <span className="text-sm text-slate-200">
                    {t("sypServices.table.mobile.sell")} :{" "}
                  </span>{" "}
                  {r.sell} SYP
                </p>
              </div>
                ...
                <thead className="sticky top-0 bg-slate-900/80 backdrop-blur-xl">
                  <tr className="text-left text-sm text-slate-300">
                    <th className="px-4 py-3 text-center font-medium">
                      {t("sypServices.table.desktop.headers.currency")}
                    </th>
                    <th className="px-4 py-3 text-center font-medium">
                      {t("sypServices.table.desktop.headers.name")}
                    </th>
                    <th className="px-4 py-3 text-center font-medium">
                      {t("sypServices.table.desktop.headers.buy")}
                    </th>
                    <th className="px-4 py-3 text-center font-medium">
                      {t("sypServices.table.desktop.headers.sell")}
                    </th>
                    <th className="px-4 py-3 text-center font-medium">
                      {t("sypServices.table.desktop.headers.change")}
                    </th>
                  </tr>
                </thead>
